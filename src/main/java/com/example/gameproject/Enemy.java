...
public class Enemy {
    public ImageView im = new ImageView(new Image(getClass().getResource("/enemy (2).png").toExternalForm()));
    public Rectangle hitbox;
    public boolean dead = false;
    public boolean isShooting;
    public long timeOfLastShot = 0;

    public int hp = 3;
    public double speed = 5;
    public boolean seePlayer = false;

    public Enemy(double startX, double startY, boolean isShooting) {
        im.setX(startX);
        im.setY(startY);
