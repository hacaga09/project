...
public class Main extends Application {
    ...
    private long firerate = 170000000;
    ...
    public void start(Stage stage) {
        ...
        timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (enemies.isEmpty()) {
                    walls.getChildren().removeAll(wall.FINAL, wall.FINAL2, wall.FINAL3);
    ...
    private void loadLevel(int level) {
        ...
        if (level == 1) {
            ...
            spawnEnemy(800, 300,false);
            spawnEnemy(680, 670,false);
            spawnEnemy(70, 285,false);
            spawnEnemy(110, 455,false);
            spawnEnemy(103, 810,false);
            ...
            spawnEnemy(879,808,true);
            spawnEnemy(350,772,false);
            spawnEnemy(468,616,false);
            spawnEnemy(953,395,true);
            spawnEnemy(893,267,true);
            spawnEnemy(315,408,false);
            spawnEnemy(76,412,true);
            ...
            walls.getChildren().addAll(wall.w70, wall.w71, wall.w72, wall.w73, wall.w74,
                    wall.w76, wall.w77, wall.w78, wall.w79, wall.w80, wall.w81,
                    wall.w82, wall.w83, wall.w84, wall.w85, wall.w86, wall.w87, wall.w88, wall.w89, wall.w90,
                    wall.w91, wall.w92, wall.w93, wall.w94, wall.w95, wall.w96, wall.w97, wall.w98, wall.w99, wall.w100,
                    wall.w101, wall.w102, wall.w103, wall.w104, wall.w105, wall.w106, wall.w107, wall.w108, wall.w109, wall.w110,
                    wall.w111, wall.w112, wall.w113, wall.w114, wall.w115, wall.w116, wall.FINAL3);

            if (finalWallTexture2 != null) {
                map.getChildren().remove(finalWallTexture2);
            }
            finalWallTexture2 = new Rectangle(436,164,8,208-164);
            finalWallTexture2.setFill(Color.BROWN);
            map.getChildren().add(finalWallTexture2);

            spawnEnemy(405,402,true);
            spawnEnemy(906,694,true);
            spawnEnemy(742,830,false);
            spawnEnemy(750,562,false);
            spawnEnemy(193,704,true);
            spawnEnemy(412,790,false);
            spawnEnemy(192,596,false);
            spawnEnemy(78,469,true);
            spawnEnemy(237,347,false);
            spawnEnemy(185,242,true);
            spawnEnemy(558,297, true);
            spawnEnemy(521,600,false);
            spawnEnemy(322,507,false);
            spawnEnemy(925,488,true);
            spawnEnemy(948,302,false);
            spawnEnemy(826,194,false);
            spawnEnemy(654,203,true);


            exitZone = new Rectangle(281, 132, 297-275, 188-132);
            exitZone.setFill(Color.GREEN);
            map.getChildren().add(exitZone);
